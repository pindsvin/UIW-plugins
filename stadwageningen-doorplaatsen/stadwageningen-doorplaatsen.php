 ...
 * Description: Zet een WordPress bericht klaar en vult er via een bookmarklet het tip-de-redactie-formulier van stadwageningen.nl mee in, inclusief automatisch verzenden (browser-side, geen server-side login).
 * Version:     2.2.0
 * Author:      Redactie
